                    ...
                    <div class="item">
                        <div class="product-entry ">
                            <a href="#" class="prod-img">
                                <img src="images/Book/Client/<?=$row['img']?>" class="img-fluid" alt="Free html5 bootstrap 4 template">
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-sm-4">
                <div class="product-desc">
                    ...
                    <p class="price">
						...
						<p><strong>Publish : <?=$row['publish']?></strong></p>
                        <h5><?=$row['detail']?></h5>
                    </p>
                    <!-- <div class="size-wrap">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            <p class="addtocart"><a href="index.php?p=cart.php&rowid=<?=$row['id']?>" class="btn btn-primary btn-addtocart"> Add to Cart</a></p>
                        </div>
                    </div>
                </div>
            </div>
